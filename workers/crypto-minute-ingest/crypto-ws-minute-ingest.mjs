...
const WS_PAIRS = (process.env.CRYPTO_WS_PAIRS ??
  "BTC-USD,ETH-USD,BNB-USD,XRP-USD,SOL-USD,TRX-USD,HYPE-USD,ZEC-USD,DOGE-USD,XMR-USD,LEO-USD,ADA-USD,BCH-USD,LINK-USD,XLM-USD,SUI-USD,TON-USD,GRT-USD,UNI-USD,LTC-USD,AVAX-USD,HBAR-USD,ONDO-USD,NEAR-USD,SHIB-USD,APT-USD,CRO-USD,WLD-USD,MNT-USD,POL-USD,DOT-USD,FTM-USD,JUP-USD,ARB-USD,STRK-USD,PEPE-USD,OP-USD,ICP-USD,IMX-USD,PYTH-USD,MKR-USD,ETC-USD,AAVE-USD,ATOM-USD,RNDR-USD,STX-USD,ALGO-USD")
  .split(",")
