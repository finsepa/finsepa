...
const RECOMMENDED = {
  ...
  STOCK_WS_ALWAYS_ON: "NVDA,AAPL,GOOGL,QQQ,SPY,MSFT,AMZN,TSM,META,AVGO,TSLA,BRK-B",
  STOCK_1D_LIVE_MINUTE_CHART: "NVDA,AAPL,GOOGL,QQQ,SPY,MSFT,AMZN,TSM,META,AVGO,TSLA,BRK-B",
