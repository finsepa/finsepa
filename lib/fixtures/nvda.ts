...
export function getNvdaChartingSeriesPoints(mode: "annual" | "quarterly"): ChartingSeriesPoint[] {
  ...
  for (let i = 0; i < base; i++) {
    ...
    const eps = 3 + i * 0.3;
    const epsBasic = eps + 0.02;
    points.push({
      periodEnd,
      revenue,
      grossProfit: revenue * 0.6,
      sga: revenue * 0.12,
      researchAndDevelopment: revenue * 0.08,
      otherOperatingExpense: null,
      totalOperatingExpenses: revenue * 0.2,
      ...
      dividendsPerShare: 0.1 + i * 0.05,
      cfDepreciationAmortization: revenue * 0.05,
      cfStockBasedCompensation: revenue * 0.02,
      cfOtherNonCashItems: null,
      cfChangeInReceivables: null,
      cfChangeInAccountsPayable: null,
      cfChangeInOtherOperating: null,
      cfOtherOperatingCashFlow: null,
      cfChangeInWorkingCapital: null,
      operatingCashFlow: revenue * 0.3,
      capitalExpenditures: -(revenue * 0.05),
      cfSaleOfPpe: null,
      cfPurchasesOfInvestments: null,
      cfProceedsFromInvestments: null,
      cfPaymentsForAcquisitions: null,
      cfProceedsFromDivestitures: null,
      cfInvestments: null,
      cfOtherInvestingCashFlow: null,
      investingCashFlow: -(revenue * 0.05),
      cfShortTermDebtIssued: null,
      cfShortTermDebtRepaid: null,
      cfLongTermDebtIssued: null,
      cfLongTermDebtRepaid: null,
      cfNetDebtIssued: null,
      cfIssuanceOfCommonStock: null,
      cfRepurchaseOfCommonStock: null,
      cfNetCommonStock: null,
      cfOtherFinancingCashFlow: null,
      financingCashFlow: -(revenue * 0.02),
      changeInCash: revenue * 0.23,
      cfExchangeRateEffect: null,
      fcfPerShare: null,
      leveredFreeCashFlow: revenue * 0.25,
      unleveredFreeCashFlow: null,
      totalAssets: revenue * 2,
      totalLiabilities: revenue * 1.1,
      cashEquivalents: revenue * 0.2,
      cashOnHand: revenue * 0.3,
      shortTermInvestments: revenue * 0.1,
      cashAndShortTermInvestments: revenue * 0.3,
      netReceivables: revenue * 0.15,
      otherReceivables: null,
      otherCurrentAssets: null,
      totalCurrentAssets: revenue * 0.8,
      propertyPlantEquipmentNet: revenue * 0.5,
      intangibleAssets: null,
      goodwill: null,
      longTermInvestments: null,
      otherNonCurrentAssets: null,
      accountsPayable: null,
      accruedLiabilities: null,
      ...
      netDebt: null,
      bookValue: revenue * 0.9,
      tangibleBookValue: revenue * 0.9,
      ...
      marketCapYoy: null,
      operatingCashFlowYoy: null,
      freeCashFlowYoy: null,
      peRatio: null,
      trailingPe: null,
      forwardPe: null,
      psRatio: null,
