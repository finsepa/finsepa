...
function ProfileHeaderDescription({ text }: { text: string }) {
  ...
  return (
    <p className="mt-4 max-w-3xl text-[14px] font-normal leading-5 text-fg-muted sm:mt-5">{text}</p>
  );
}
...
function ProfileHeaderStats({
  ...
  return (
    <dl className="mt-4 flex w-full max-w-3xl flex-row items-stretch gap-0 sm:mt-5">
      <div className="flex min-w-0 flex-1 flex-col gap-1 border-r border-stroke pr-4 sm:pr-8">
        <dt className="text-[13px] font-normal leading-5 text-fg-muted">Size</dt>
        <dd className="text-[16px] font-semibold leading-6 tabular-nums text-fg sm:text-[20px] sm:leading-7">
          {sizeLabel}
        </dd>
      </div>
      <div className="flex min-w-0 flex-1 flex-col gap-1 border-r border-stroke px-4 sm:px-8">
        <dt className="text-[13px] font-normal leading-5 text-fg-muted">No. of stocks</dt>
        <dd className="text-[16px] font-semibold leading-6 tabular-nums text-fg sm:text-[20px] sm:leading-7">
          {stocksLabel}
        </dd>
      </div>
      <div className="flex min-w-0 flex-1 flex-col gap-1 pl-4 sm:pl-8">
        <dt className="text-[13px] font-normal leading-5 text-fg-muted">Last update</dt>
        <dd className="text-[16px] font-semibold leading-6 text-fg sm:text-[20px] sm:leading-7">
          {lastUpdateLabel}
        </dd>
      </div>
    </dl>
  ...
  return (
    <div className="relative min-w-0">
      <nav
        ...
        className="flex min-w-0 items-center px-4 py-3 text-[14px] text-fg-muted max-md:border-b-0 md:border-b md:border-stroke-shell sm:px-9"
      >
        ...
        <div className="sm:hidden">
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0">
              <h1 className="text-[24px] font-semibold leading-8 tracking-tight text-fg">{profileName}</h1>
              <p className="mt-0.5 text-[14px] font-normal leading-5 text-fg-muted">
