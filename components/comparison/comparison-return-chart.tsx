...
export function ComparisonReturnChart({
  ...
  return (
    <section className="w-full min-w-0 max-w-full overflow-hidden bg-panel">
                    ...
                    >
                      ...
                      <div className="mt-1.5 space-y-0.5">
                        {tip.lines.map((line) => (
                          <p
                            key={line.ticker}
                            className="flex items-center gap-2 whitespace-nowrap text-[12px] font-normal leading-4 text-fg"
                          >
                            <span
                ...
                >
                  {chartYears.map((year) => (
                    <div key={year} className="min-w-0 px-0.5 text-center">
                      <span className="text-balance font-['Inter'] text-[11px] font-normal leading-snug text-fg-muted sm:text-[12px]">
                        {year}
                      </span>
                    </div>
                  ))}
