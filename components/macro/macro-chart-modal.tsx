...
export function MacroChartModal({
  ...
  return (
    <AppModalOverlay open={open} onClose={onClose} zIndex={300}>
      ...
      >
        <div className="flex shrink-0 flex-wrap items-center justify-between gap-3 border-b border-stroke px-5 pt-5 pb-3">
          <div className="min-w-0 flex-1">
            ...
            {periodCaption ? (
              <p className="mt-1 text-[12px] leading-4 text-fg-muted">{periodCaption}</p>
            ) : null}
          </div>
