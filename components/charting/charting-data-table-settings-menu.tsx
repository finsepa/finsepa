      ...
      <button
        ...
        className={cn(
          variant === "rail"
            ...
            : variant === "badge"
              ? cn(
                  "inline-flex h-full shrink-0 items-center justify-center px-1.5 text-[#5C5D5F]",
                  "transition-colors hover:bg-[#FAFAFA] hover:text-[#141414]",
                  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#141414]/15",
                  open && "bg-[#F4F4F5] text-[#141414]",
                )
              : cn(
                  "inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-[10px] border border-transparent text-[#5C5D5F]",
                  "transition-colors hover:bg-[#F4F4F5] hover:text-[#141414]",
        ...
        >
          ...
          >
            <div role="menuitem" className={dropdownMenuPlainItemRowClassName()}>
              <span className="min-w-0 flex-1 text-sm font-medium leading-5 text-[#141414]">Show values</span>
              <PillSwitch
