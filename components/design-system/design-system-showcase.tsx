  ...
  return (
    <div className="mx-auto max-w-4xl space-y-10 px-4 py-8 sm:px-6 lg:px-8">
      ...
      <Section
        ...
        description="Track and segments use 10px corner radius. Active label: Inter Medium 14px / 20px / #141414, white surface, elevation shadow. Inactive: regular, zinc-500."
      >
