...
export const secondaryFillButtonClassName =
  "inline-flex shrink-0 items-center justify-center gap-2 rounded-[10px] bg-[#F4F4F5] px-4 py-2 text-[14px] font-medium leading-5 text-[#09090B] transition-colors hover:bg-[#EBEBEB] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#09090B]/15 disabled:pointer-events-none disabled:opacity-50";
