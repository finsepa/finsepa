 ...
 */
export const secondaryOutlineButtonClassName = `inline-flex h-9 shrink-0 items-center justify-center gap-1.5 rounded-[10px] ${whiteSurfaceButtonChromeClass} px-3 text-[13px] font-semibold leading-none text-[#0F0F0F] transition-colors duration-100 hover:bg-[#F4F4F5] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0F0F0F]/15`;

/** Grey fill toolbar action — Charting + Add Company / + Add Metric. */
export const secondaryFillButtonClassName =
  "inline-flex shrink-0 items-center justify-center gap-2 rounded-[10px] bg-[#F4F4F5] px-4 py-2 text-[14px] font-medium leading-5 text-[#0F0F0F] transition-colors hover:bg-[#EBEBEB] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0F0F0F]/15 disabled:pointer-events-none disabled:opacity-50";
