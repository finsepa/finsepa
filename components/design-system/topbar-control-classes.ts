...
export const topbarSquircleIconClass = `flex h-9 w-9 shrink-0 items-center justify-center rounded-[10px] ${whiteSurfaceButtonChromeClass} text-[#141414] transition-all duration-100 hover:bg-[#F4F4F5]`;

/** Label + icon, same surface as portfolio strip / squircle row (variable width). */
export const topbarSquircleTextButtonClass = `inline-flex h-9 shrink-0 items-center gap-2 rounded-[10px] ${whiteSurfaceButtonChromeClass} px-3 text-sm font-medium leading-5 text-[#141414] transition-all duration-100 hover:bg-[#F4F4F5]`;
...
export const topbarSquircleClusterItemClass =
  "flex h-9 w-9 shrink-0 items-center justify-center text-[#141414] transition-colors hover:bg-[#F4F4F5] active:bg-[#E4E4E7]";
