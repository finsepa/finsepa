...
export const SCREENER_TABLE_PAGINATION_BTN = cn(
  "inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-[10px] text-[#141414] transition-all duration-100 hover:bg-[#F4F4F5] disabled:cursor-not-allowed disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#141414]/15 focus-visible:ring-offset-2",
...
const PAGE_NUM_INACTIVE =
  "inline-flex h-9 min-w-9 max-w-12 shrink-0 items-center justify-center rounded-[10px] px-2 text-sm font-medium text-[#141414] transition-colors hover:bg-[#F4F4F5] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#141414]/15 focus-visible:ring-offset-2";

/** Active page: bordered tile (same family as `SCREENER_TABLE_PAGINATION_BTN`, no fill). */
const PAGE_NUM_ACTIVE = cn(
  "inline-flex h-9 min-w-9 max-w-12 shrink-0 items-center justify-center rounded-[10px] px-2 text-sm font-semibold tabular-nums text-[#141414] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#141414]/15 focus-visible:ring-offset-2",
  whiteSurfaceButtonChromeClass,
);
        ...
        <div className="flex max-w-full flex-wrap items-center justify-center gap-1.5 sm:gap-2">
          {items.map((it, i) =>
            it === "ellipsis" ? (
              <span
                key={`e-${i}`}
                className="inline-flex h-9 min-w-6 select-none items-center justify-center text-sm font-medium text-[#141414] tabular-nums"
                aria-hidden
              >
                ...
              </span>
