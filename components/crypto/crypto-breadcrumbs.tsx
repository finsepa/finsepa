...
export function CryptoBreadcrumbs({ symbol }: Props) {
  ...
  return (
    <nav
      ...
      className="hidden min-w-0 items-center gap-3 px-4 py-3 text-[14px] text-[#5C5D5F] md:flex md:border-b md:border-[#E4E4E7] sm:px-9"
    >
      <div className="flex min-w-0 flex-1 flex-wrap items-center gap-2 sm:flex-nowrap">
        ...
        {breadcrumbSep}
        <span
          className="min-w-0 shrink-0 truncate font-medium text-[#141414]"
          title={pairLabel}
          aria-current="page"
        >
          {pairLabel}
