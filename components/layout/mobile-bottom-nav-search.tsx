  ...
  return (
    <div className={cn("flex h-full min-w-0 flex-1 items-center px-4", className)}>
      <input
        ...
        placeholder="Search..."
        className="h-full w-full min-w-0 bg-transparent text-base leading-5 text-[#0F0F0F] outline-none placeholder:text-[#A1A1AA] caret-[#0F0F0F]"
        autoComplete="off"
        autoCorrect="off"
        enterKeyHint="search"
        role="searchbox"
...
/** Fixed results panel anchored above the morphing search pill (tracks visual viewport + keyboard). */
