...
export function FinancialsColumnOrderToggle({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex h-9 w-9 shrink-0 cursor-pointer items-center justify-center rounded-[10px] text-fg outline-none transition-colors duration-100 hover:bg-surface-muted active:bg-surface focus-visible:ring-2 focus-visible:ring-neutral-900/10 focus-visible:ring-offset-2",
