...
export function FinancialsColumnOrderToggle({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex h-9 w-9 shrink-0 cursor-pointer items-center justify-center rounded-[10px] text-[#141414] outline-none transition-colors duration-100 hover:bg-[#F4F4F5] active:bg-white focus-visible:ring-2 focus-visible:ring-neutral-900/10 focus-visible:ring-offset-2",
