...
/** Pre-market (BMO) — light keeps #FFEDD5 / #EA580C; dark uses orange soft + orange tokens. */
  ...
  return (
    ...
    >
      <rect
        ...
        height="20"
        rx="10"
        className="fill-[#FFEDD5] dark:fill-[var(--fs-orange-soft)]"
      />
      <g clipPath={`url(#${clipId})`}>
        <path
          ...
          className="fill-[#141414] stroke-[#EA580C] dark:stroke-[var(--fs-orange)]"
          strokeWidth="1.5"
        />
      </g>
      <defs>
