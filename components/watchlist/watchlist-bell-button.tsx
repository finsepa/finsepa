  ...
  return (
    ...
    >
      <button
        ...
        className={
          isDetail
            ? `flex h-7 w-7 shrink-0 items-center justify-center rounded-[10px] bg-[#F4F4F5] text-[#141414] outline-none transition-colors hover:bg-[#EBEBEB] focus-visible:ring-2 focus-visible:ring-[#141414]/15 ${buttonClassName}`
